    ...
    <div className="w-full max-w-full sm:max-w-3xl mx-0 px-4 sm:px-0">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          {/* Visitors Details */}
          <div>
            <h3 className="text-sm font-medium text-neutral mb-3">
              Detalle de entradas
            </h3>
        ...
        <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-4 border-t border-gray-100">
          <button
            ...
            onClick={onBack}
            disabled={loading}
            className="btn btn-ghost text-neutral disabled:opacity-50 h-12 w-full sm:w-auto"
          >
            Volver
          </button>
          <button
